...
func TestConfigLoadNotifierAcceptsLegacyOwnerEnvWithoutProjects(t *testing.T) {
	isolateLocalConfig(t)
	t.Setenv("CTR_GO_PROFILE", "notifier")
	t.Setenv("CTR_GO_ALLOWED_USER_IDS", "")
	t.Setenv("CTR_ALLOWED_USER_IDS", "123456789")
	t.Setenv("CTR_GO_PROJECTS_FILE", filepath.Join(t.TempDir(), "missing-projects.json"))
